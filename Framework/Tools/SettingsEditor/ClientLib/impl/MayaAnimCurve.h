...
public:
	...
	typedef std::vector<EtKey, SimpleStdAllocator<EtKey>> EtKeyArray;
	...
	MayaAnimCurve( EtKeyArray&& keys, EtInfinityType preInfinity, EtInfinityType postInfinity, bool isWeighted = false )
