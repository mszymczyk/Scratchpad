...
//#define DEFINE_ATTRIBUTES_BEGIN_INHERIT(nodeName, typeName, inheritFrom) \
//nodeName::nodeName##TypeDesc nodeName::__s##nodeName##TypeDesc; \


#define DEFINE_ATTRIBUTE_DISTANCE(nodeName, attrName, shortName ) \
const AttributeDesc nodeName::Attribute_##attrName::descX( &__s##nodeName##TypeDesc.attrSet_, nodeName::Attribute_##attrName::ordinalX, #attrName "X", shortName "x", nodeName::Attribute_##attrName::typeX, offsetof( nodeName, attrName.valueX ), nodeName::Attribute_##attrName::hasNetwork ); \
const AttributeDesc nodeName::Attribute_##attrName::descY( &__s##nodeName##TypeDesc.attrSet_, nodeName::Attribute_##attrName::ordinalY, #attrName "Y", shortName "y", nodeName::Attribute_##attrName::typeY, offsetof( nodeName, attrName.valueY ), nodeName::Attribute_##attrName::hasNetwork ); \
const AttributeDesc nodeName::Attribute_##attrName::descZ( &__s##nodeName##TypeDesc.attrSet_, nodeName::Attribute_##attrName::ordinalZ, #attrName "Z", shortName "z", nodeName::Attribute_##attrName::typeZ, offsetof( nodeName, attrName.valueZ ), nodeName::Attribute_##attrName::hasNetwork ); \
...
DEFINE_ATTRIBUTES_BEGIN( TransformNode, "transform" );
