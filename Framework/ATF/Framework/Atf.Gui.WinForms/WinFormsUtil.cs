...
namespace Sce.Atf
{
    ...
    public static class WinFormsUtil
    {
        ...
        public static void UpdateScrollbars(
            ...
            Size visibleSize,
            Size canvasSize,
            bool forceVScrollBarVisible = false,
            bool forceHScrollBarVisible = false
            )
        {
            if (vScrollBar != null)
            {
                ...
                vScrollBar.Visible = (vScrollDistance > 0) || forceVScrollBarVisible;
            ...
            if (hScrollBar != null)
            {
                ...
                hScrollBar.Visible = (hScrollDistance > 0) || forceHScrollBarVisible;
