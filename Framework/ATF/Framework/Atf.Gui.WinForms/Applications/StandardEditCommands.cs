    ...
    public class StandardEditCommands : ICommandClient, IContextMenuCommandProvider, IInitializable
    {
        ...
        private static ICollection<string> s_clipboardFormatsToIgnore =
            new[]
            {
                ...
                "ObjectLink",
                "EnterpriseDataProtectionId", // crash
                "FileContents" // this causes crash in ntdll.dll when systemClipboard.GetData(format, true); is called, but only when native code debugging is enabled
                // see https://gist.github.com/MattyBoy4444/521547 for possible solution
