...
namespace misz.StatsViewer
{
    ...
    public class DefaultSessionRenderer : SessionRenderer, IDisposable
    {
        /// <summary>
        /// Constructor</summary>
        public DefaultSessionRenderer()
        ...
        public DefaultSessionRenderer(Font font)
            : base(font)
        {
        }
