...
namespace misz.StatsViewer.DomNodeAdapters
{
    ...
    public class Stat : DomNodeAdapter//, ITrack, ICloneable
    {
        ...
        public string Name
        {
            get { return (string)DomNode.GetAttribute(StatsViewerSchema.statType.nameAttribute); }
			set { DomNode.SetAttribute( StatsViewerSchema.statType.nameAttribute, value ); }
        }
