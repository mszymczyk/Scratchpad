...
namespace misz.StatsViewer
{
    ...
    public class StatsViewerProgram
    {
        /// <summary>
        ...
        static void Main()
        {
            ...
            var catalog = new TypeCatalog(
                ...
                typeof(StatsViewerEditor),              // timeline editor component
				typeof(StatsViewerCommands),            // defines Timeline-specific commands
				typeof(StatsViewerHelpAboutCommand)     // Help -> About command
            ...
            {
                Text = "Live Stats Viewer".Localize(),
