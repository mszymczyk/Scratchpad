...
namespace misz.StatsViewer
{
    ...
    [Export(typeof(StatsViewerCommands))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class StatsViewerCommands : ICommandClient, IInitializable
    {
        /// <summary>
        /// Constructor</summary>
        ...
        public StatsViewerCommands(ICommandService commandService, IContextRegistry contextRegistry)
        {
