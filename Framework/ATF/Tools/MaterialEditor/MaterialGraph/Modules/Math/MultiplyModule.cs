...
{
    /// <summary>
    /// Adapts DomNode to a MultiplyModule</summary>
    public class MultiplyModule : MaterialGraphModuleAdapter
    {
        public static DomNodeType multiplyType;
        ...
        public static void DefineDomNodeType()
        {
            ...
            pinIn_A_RGBA = new MaterialGraphPin( "A (RGBA)".Localize(), MaterialGraphPin.MaterialGraphPinTypeName, 0, MaterialGraphPin.ComponentType.RGBA );
            pinIn_B_RGBA = new MaterialGraphPin( "B (RGBA)".Localize(), MaterialGraphPin.MaterialGraphPinTypeName, 1, MaterialGraphPin.ComponentType.RGBA );

            string prettyName = "Multiply".Localize();

            DomNodeType dnt = DefineModuleType(
                new XmlQualifiedName( "multiplyType", Schema.NS ),
                prettyName,
                prettyName,
                Resources.AndImage,
            ...
            multiplyType = dnt;
            multiplyType.Define( new ExtensionInfo<MultiplyModule>() );
        }
