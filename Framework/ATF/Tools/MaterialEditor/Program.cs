    ...
    public class Program
    {
        ...
        static void Main()
        {
            ...
            var catalog = new TypeCatalog(
                ...
                typeof(MaterialModulePlugin),           // component that defines module types specific to material editor
            ...
            if ( !FxCompiler.FxCompilerInterop.StartUp( new FxCompiler.FxCompilerInterop.LogCallbackType(
            ...
            {
                Outputs.WriteLine( OutputMessageType.Error, "Couldn't launch FxCompiler native dll" );
            }
            ...
            FxCompiler.FxCompilerInterop.ShutDown();
        }
        ...
        private class MyPropertyEditor : PropertyEditor
        {
            ...
            protected override void Configure(out PropertyGrid propertyGrid, out ControlInfo controlInfo)
            {
                ...
                propertyGrid = new PropertyGrid(PropertyGridMode.DisplayTooltips | PropertyGridMode.DisplayDescriptions | PropertyGridMode.PropertySorting, new PropertyGridView());
