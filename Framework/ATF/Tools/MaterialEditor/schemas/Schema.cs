...
namespace CircuitEditorSample
{
    public static class Schema
    {
        ...
        private static void Initialize(Func<string, string, DomNodeType> getNodeType, Func<string, string, ChildInfo> getRootElement)
        {
            ...
            circuitDocumentType.instanceChild = circuitDocumentType.Type.GetChildInfo("instance");
            ...
            materialInstancesType.Type = getNodeType("http://sony.com/gametech/circuits/1_0", "materialInstancesType");
            materialInstancesType.instanceChild = materialInstancesType.Type.GetChildInfo("instance");

            materialInstanceType.Type = getNodeType("http://sony.com/gametech/circuits/1_0", "materialInstanceType");
            materialInstanceType.nameAttribute = materialInstanceType.Type.GetAttributeInfo("name");
            materialInstanceType.parameterChild = materialInstanceType.Type.GetChildInfo("parameter");

            materialInstanceParameterType.Type = getNodeType("http://sony.com/gametech/circuits/1_0", "materialInstanceParameterType");
            materialInstanceParameterType.moduleAttribute = materialInstanceParameterType.Type.GetAttributeInfo("module");
            materialInstanceParameterType.displayNameAttribute = materialInstanceParameterType.Type.GetAttributeInfo("displayName");
            materialInstanceParameterType.categoryAttribute = materialInstanceParameterType.Type.GetAttributeInfo("category");
            materialInstanceParameterType.descriptionAttribute = materialInstanceParameterType.Type.GetAttributeInfo("description");
            materialInstanceParameterType.converterAttribute = materialInstanceParameterType.Type.GetAttributeInfo("converter");
            materialInstanceParameterType.editorAttribute = materialInstanceParameterType.Type.GetAttributeInfo("editor");
            materialInstanceParameterType.valueTypeAttribute = materialInstanceParameterType.Type.GetAttributeInfo("valueType");
            materialInstanceParameterType.overrideAttribute = materialInstanceParameterType.Type.GetAttributeInfo("override");
            materialInstanceParameterType.stringValueAttribute = materialInstanceParameterType.Type.GetAttributeInfo("stringValue");
            materialInstanceParameterType.floatValueAttribute = materialInstanceParameterType.Type.GetAttributeInfo("floatValue");
            materialInstanceParameterType.vector3ValueAttribute = materialInstanceParameterType.Type.GetAttributeInfo("vector3Value");
            materialInstanceParameterType.boolValueAttribute = materialInstanceParameterType.Type.GetAttributeInfo("boolValue");
            materialInstanceParameterType.colorValueAttribute = materialInstanceParameterType.Type.GetAttributeInfo("colorValue");
            materialInstanceParameterType.uriValueAttribute = materialInstanceParameterType.Type.GetAttributeInfo("uriValue");

            controlPointType.Type = getNodeType("http://sony.com/gametech/circuits/1_0", "controlPointType");
            ...
            curveType.Type = getNodeType("http://sony.com/gametech/circuits/1_0", "curveType");
        ...
        public static class materialInstancesType
        {
            public static DomNodeType Type;
            public static ChildInfo instanceChild;
        }
        ...
        public static class materialInstanceType
        {
            public static DomNodeType Type;
            public static AttributeInfo nameAttribute;
            public static ChildInfo parameterChild;
        }

        public static class materialInstanceParameterType
        {
            public static DomNodeType Type;
            ...
            public static AttributeInfo editorAttribute;
            public static AttributeInfo valueTypeAttribute;
            public static AttributeInfo overrideAttribute;
            public static AttributeInfo stringValueAttribute;
            public static AttributeInfo floatValueAttribute;
            public static AttributeInfo vector3ValueAttribute;
            public static AttributeInfo boolValueAttribute;
            public static AttributeInfo colorValueAttribute;
            public static AttributeInfo uriValueAttribute;
        }
