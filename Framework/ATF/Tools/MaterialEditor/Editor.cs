...
namespace CircuitEditorSample
{
    ...
    public class Editor : DynamicObject, IDocumentClient, IControlHostClient, IInitializable
    {
        ...
        void IInitializable.Initialize()
        {
            ...
            if ( m_materialModulePlugin != null )
            {
                // define pin/connection pens
                //var pen = D2dFactory.CreateSolidBrush( Color.White );
                //m_theme.RegisterCustomBrush( m_materialModulePlugin.RGBChannelPinTypeName, pen );
                //m_theme.RegisterCustomBrush( m_materialModulePlugin.RGBAChannelPinTypeName, pen );
                //pen = D2dFactory.CreateSolidBrush( Color.Red );
                //m_theme.RegisterCustomBrush( m_materialModulePlugin.RedChannelPinTypeName, pen );
                //pen = D2dFactory.CreateSolidBrush( Color.Green );
                //m_theme.RegisterCustomBrush( m_materialModulePlugin.GreenChannelPinTypeName, pen );
                //pen = D2dFactory.CreateSolidBrush( Color.Blue );
                //m_theme.RegisterCustomBrush( m_materialModulePlugin.BlueChannelPinTypeName, pen );
                //pen = D2dFactory.CreateSolidBrush( Color.DarkGray );
                //m_theme.RegisterCustomBrush( m_materialModulePlugin.AlphaChannelPinTypeName, pen );
                var pen = D2dFactory.CreateSolidBrush( Color.Red );
                m_theme.RegisterCustomBrush( MaterialGraphPin.ComponentType.Red, pen );
                pen = D2dFactory.CreateSolidBrush( Color.Green );
                m_theme.RegisterCustomBrush( MaterialGraphPin.ComponentType.Green, pen );
                pen = D2dFactory.CreateSolidBrush( Color.Blue );
                m_theme.RegisterCustomBrush( MaterialGraphPin.ComponentType.Blue, pen );
                pen = D2dFactory.CreateSolidBrush( Color.DarkGray );
                m_theme.RegisterCustomBrush( MaterialGraphPin.ComponentType.Alpha, pen );
                pen = D2dFactory.CreateSolidBrush( Color.Yellow );
                m_theme.RegisterCustomBrush( MaterialGraphPin.ComponentType.RG, pen );
                pen = D2dFactory.CreateSolidBrush( Color.Gray );
                m_theme.RegisterCustomBrush( MaterialGraphPin.ComponentType.RGB, pen );
                pen = D2dFactory.CreateSolidBrush( Color.White );
                m_theme.RegisterCustomBrush( MaterialGraphPin.ComponentType.RGBA, pen );
            }
        ...
        public static DocumentClientInfo EditorInfo =
            new DocumentClientInfo("Material".Localize(), ".material", null, null);
        ...
        /// Component that adds module types to the editor</summary>
        [Import( AllowDefault = true )]
        protected MaterialModulePlugin m_materialModulePlugin;

        [Import]
        private CircuitControlRegistry m_circuitControlRegistry = null;

        [Import( AllowDefault = true )]
        private CustomResourceLister m_resourceLister = null;
