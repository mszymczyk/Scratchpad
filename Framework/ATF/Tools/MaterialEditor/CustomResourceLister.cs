...
namespace CircuitEditorSample
{
    ...
    [Export(typeof(CustomResourceLister))]
    [Export(typeof(IInitializable))]
    [PartCreationPolicy(CreationPolicy.Any)]
    public class CustomResourceLister : ICommandClient, IControlHostClient, IInitializable
    {
        /// <summary>
        /// Constructor</summary>
        ...
        public void Initialize()
        {
            ...
            m_control.Controls.Add( m_splitContainer );
        ...
        public void Refresh()
        {
            // if CustomResourceLister has been initialized, refresh tree control at the root
        ...
        private class ListViewContext : IListView, IItemView, IObservableContext, ISelectionContext
        {
            ...
            public virtual void GetInfo(object item, ItemInfo info)
            {
                Uri resourceUri = CustomResourceLister.GetUriFromTag(item);
                if (resourceUri != null)
                {
