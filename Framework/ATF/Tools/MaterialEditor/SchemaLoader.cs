    ...
    public class SchemaLoader : XmlSchemaTypeLoader
    {
        ...
        protected override void OnSchemaSetLoaded(XmlSchemaSet schemaSet)
        {
            foreach (XmlSchemaTypeCollection typeCollection in GetTypeCollections())
            {
                ...
                Schema.materialInstanceType.Type.Define( new ExtensionInfo<MaterialInstance>() );
                Schema.materialInstanceType.Type.Define( new ExtensionInfo<MaterialInstanceProperties>() );
                Schema.materialInstanceParameterType.Type.Define( new ExtensionInfo<MaterialInstanceParameter>() );
