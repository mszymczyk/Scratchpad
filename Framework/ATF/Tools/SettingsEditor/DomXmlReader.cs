...
{
    /// <summary>
    /// Class to read DOM data defined by an XML schema
    /// This is a customized reader that is copy of original Sce.Atf.Dom.DomXmlReader but can skip elements that aren't defined in schema.
    /// Atf reader just stops reading and throws an exception
    /// For differences search for: se_diff
    /// </summary>
    public class DomXmlReader
    {
        ...
        protected virtual DomNode ReadElement(ChildInfo nodeInfo, XmlReader reader)
        {
            ...
            // se_diff
            // error CS0122: 'Sce.Atf.Dom.SubstitutionGroupChildRule' is inaccessible due to its protection level
            // SubstitutionGroupChildRule is defined internal in XmlSchemaTypeLoader.cs
            //
