...
protected:
    virtual HRESULT                 CreateFromFile( LPCSTR szFileName,
...
public:
    ...
    virtual HRESULT                 Create( LPCSTR szFileName, bool bCreateAdjacencyIndices = false );
    ...
    uint64_t                          GetNumVertices( UINT iMesh, UINT iVB );
    uint64_t                          GetNumIndices( UINT iMesh );
